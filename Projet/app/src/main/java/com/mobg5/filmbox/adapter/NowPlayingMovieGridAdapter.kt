...
import com.mobg5.filmbox.databinding.HorizontalScrollNowPlayingBinding

class NowPlayingMovieGridAdapter(private val onClickListener: OnClickListener):
    ListAdapter<ResultsMovies, NowPlayingMovieGridAdapter.ResultsMoviesViewHolder>(DiffCallback) {

    class ResultsMoviesViewHolder(private var binding: HorizontalScrollNowPlayingBinding):
        RecyclerView.ViewHolder(binding.root) {
        fun bind(resultsMovies: ResultsMovies) {
            binding.nowPlaying = resultsMovies
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        return ResultsMoviesViewHolder(HorizontalScrollNowPlayingBinding.inflate(LayoutInflater.from(parent.context)))
    }
