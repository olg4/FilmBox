...
import com.mobg5.filmbox.databinding.GridMovieBinding

class ExploreMoviesGridAdapter(private val onClickListener: OnClickListener):
    ListAdapter<ResultsMovies, ExploreMoviesGridAdapter.ResultsMoviesViewHolder>(DiffCallback) {

    class ResultsMoviesViewHolder(private var binding: GridMovieBinding):
        RecyclerView.ViewHolder(binding.root) {
        fun bind(resultsMovies: ResultsMovies) {
            binding.movie = resultsMovies
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        return ResultsMoviesViewHolder(GridMovieBinding.inflate(LayoutInflater.from(parent.context)))
    }
