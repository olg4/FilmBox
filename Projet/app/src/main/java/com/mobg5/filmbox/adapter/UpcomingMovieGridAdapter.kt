...
import com.mobg5.filmbox.databinding.HorizontalScrollMovieBinding

class UpcomingMovieGridAdapter(private val onClickListener: OnClickListener):
    ListAdapter<ResultsMovies, UpcomingMovieGridAdapter.ResultsMoviesViewHolder>(DiffCallback) {

    class ResultsMoviesViewHolder(private var binding: HorizontalScrollMovieBinding):
        RecyclerView.ViewHolder(binding.root) {
        fun bind(resultsMovies: ResultsMovies) {
            binding.upcoming = resultsMovies
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        return ResultsMoviesViewHolder(HorizontalScrollMovieBinding.inflate(LayoutInflater.from(parent.context)))
    }
